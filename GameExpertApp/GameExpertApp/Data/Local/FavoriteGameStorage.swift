...
class FavoriteGameStorage: FavoriteGameRepository {
    ...
    func getFavoriteGames() -> AnyPublisher<[Game], Error> {
       ...
       func addFavorite(game favoriteGame: GameProtocolForFavorites) -> AnyPublisher<Void, Error> {
       ...
       func removeFavorite(game favoriteGame: GameProtocolForFavorites) -> AnyPublisher<Void, Error> {
           return Future<Void, Error> { [weak self] promise in
               guard let self = self else {
                   promise(.failure(URLError(.cancelled)))
                   return
    ...
    func isFavorite(game favoriteGame: GameProtocolForFavorites) -> AnyPublisher<Bool, Error> {
