...
public struct GameResponseDTO: Codable {
    let count: Int
    let next: String?
...
public struct FiltersDTO: Codable {
    let years: [FiltersYearDTO]
}

public struct FiltersYearDTO: Codable {
    let from, to: Int
    let filter: String
    let decade: Int
...
public struct YearYearDTO: Codable {
    let year, count: Int
    let nofollow: Bool
}
...
public struct GameDTO: Codable, Identifiable {
    ...
    public let ratings: [RatingDTO]
    public let ratingsCount, reviewsTextCount, added: Int
    public let addedByStatus: AddedByStatusDTO
    public let metacritic, playtime, suggestionsCount: Int
    public let updated: String
    public let userGame: JSONNull?
    public let reviewsCount: Int
    public let saturatedColor, dominantColor: ColorDTO
    public let platforms: [PlatformElementDTO]
    public let parentPlatforms: [ParentPlatformDTO]
    public let genres: [GenreDTO]
    public let stores: [StoreDTO]
    public let clip: JSONNull?
    public let tags: [GenreDTO]
    public let esrbRating: EsrbRatingDTO
    public let shortScreenshots: [ShortScreenshotDTO]
...
public struct AddedByStatusDTO: Codable {
...
public struct EsrbRatingDTO: Codable {
    let id: Int
...
public enum DomainDTO: String, Codable {
...
public enum LanguageDTO: String, Codable {
    case eng = "eng"
}

public struct ParentPlatformDTO: Codable {
    let platform: EsrbRatingDTO
}

public struct PlatformElementDTO: Codable {
...
public struct PlatformPlatformDTO: Codable {
    let id: Int
    let name, slug: String
...
public struct RequirementsDTO: Codable {
    let minimum: String
...
public enum TitleDTO: String, Codable {
...
public struct ShortScreenshotDTO: Codable {
    let id: Int
    let image: String
}
